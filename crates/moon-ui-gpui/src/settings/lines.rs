...
use super::{hsla_u8, separator, slider_row, SettingsView};
...
impl SettingsView {
    ...
    fn collapse_header(&self, cx: &Context<Self>, key: &'static str, title: &str) -> impl IntoElement {
        ...
        h_flex()
            ...
            .py_1()
            .items_center()
            .child(div().text_color(rgb(hex(palette::TEXT_2))).child(if open { "▾" } else { "▸" }))
    ...
    fn line_body(&self, cx: &Context<Self>, ed: &LineEd, markers: bool, checks: &[Check]) -> AnyElement {
        let chk = |idx: usize| -> AnyElement {
            match checks.get(idx) {
                Some((id, label, get, set)) => self.ord_check(cx, id, label, *get, *set).into_any_element(),
        ...
        let mut col = v_flex()
            ...
            .child(
                h_flex()
                    .gap_2()
                    .items_center()
                    .child(ColorPicker::new(&ed.color))
    ...
    fn line_section(
        ...
        Collapsible::new()
            .open(self.open_lines.contains(key))
            .child(self.collapse_header(cx, key, title))
            .content(self.line_body(cx, ed, markers, checks))
    }
    ...
    pub(super) fn lines_tab(&self, cx: &Context<Self>) -> impl IntoElement {
        ...
        v_flex()
            ...
            .child(self.line_section(cx, "buy", "Buy", &l.buy, true, &[
                ("buy-d", "dashed", |o| o.buy.dashed, |o, v| o.buy.dashed = v),
                ("buy-s", "start cross", |o| o.buy.start_marker, |o, v| o.buy.start_marker = v),
                ("buy-e", "end cross", |o| o.buy.end_marker, |o, v| o.buy.end_marker = v),
                ("buy-k", "knots", |o| o.buy.knots, |o, v| o.buy.knots = v),
            ]))
            .child(self.line_section(cx, "sell", "Sell", &l.sell, true, &[
                ("sell-d", "dashed", |o| o.sell.dashed, |o, v| o.sell.dashed = v),
                ("sell-s", "start cross", |o| o.sell.start_marker, |o, v| o.sell.start_marker = v),
                ("sell-e", "end cross", |o| o.sell.end_marker, |o, v| o.sell.end_marker = v),
                ("sell-k", "knots", |o| o.sell.knots, |o, v| o.sell.knots = v),
            ]))
            .child(self.line_section(cx, "stop", "Stop", &l.stop, true, &[
                ("stop-d", "dashed", |o| o.stop.dashed, |o, v| o.stop.dashed = v),
                ("stop-s", "start cross", |o| o.stop.start_marker, |o, v| o.stop.start_marker = v),
                ("stop-e", "end cross", |o| o.stop.end_marker, |o, v| o.stop.end_marker = v),
                ("stop-k", "knots", |o| o.stop.knots, |o, v| o.stop.knots = v),
            ]))
            .child(self.line_section(cx, "trailing", "Trailing", &l.trailing, true, &[
                ("tr-d", "dashed", |o| o.trailing.dashed, |o, v| o.trailing.dashed = v),
                ("tr-s", "start cross", |o| o.trailing.start_marker, |o, v| o.trailing.start_marker = v),
                ("tr-e", "end cross", |o| o.trailing.end_marker, |o, v| o.trailing.end_marker = v),
                ("tr-k", "knots", |o| o.trailing.knots, |o, v| o.trailing.knots = v),
            ]))
            .child(self.line_section(cx, "tp", "Take Profit", &l.take_profit, true, &[
                ("tp-d", "dashed", |o| o.take_profit.dashed, |o, v| o.take_profit.dashed = v),
                ("tp-s", "start cross", |o| o.take_profit.start_marker, |o, v| o.take_profit.start_marker = v),
                ("tp-e", "end cross", |o| o.take_profit.end_marker, |o, v| o.take_profit.end_marker = v),
                ("tp-k", "knots", |o| o.take_profit.knots, |o, v| o.take_profit.knots = v),
            ]))
            .child(self.line_section(cx, "vstop", "VStop", &l.vstop, true, &[
                ("vs-d", "dashed", |o| o.vstop.dashed, |o, v| o.vstop.dashed = v),
                ("vs-s", "start cross", |o| o.vstop.start_marker, |o, v| o.vstop.start_marker = v),
                ("vs-e", "end cross", |o| o.vstop.end_marker, |o, v| o.vstop.end_marker = v),
                ("vs-k", "knots", |o| o.vstop.knots, |o, v| o.vstop.knots = v),
            ]))
            .child(self.line_section(cx, "pc", "Pending cond", &l.pending_cond, true, &[
                ("pc-d", "dashed", |o| o.pending_cond.dashed, |o, v| o.pending_cond.dashed = v),
                ("pc-s", "start cross", |o| o.pending_cond.start_marker, |o, v| o.pending_cond.start_marker = v),
                ("pc-e", "end cross", |o| o.pending_cond.end_marker, |o, v| o.pending_cond.end_marker = v),
                ("pc-k", "knots", |o| o.pending_cond.knots, |o, v| o.pending_cond.knots = v),
            ]))
            .child(self.line_section(cx, "liq", "Liquidation", &l.liq, false, &[
                ...
                Collapsible::new()
                    ...
                    .content(
                        v_flex()
                            ...
                            .gap_1()
                            .pl_4()
                            .child(self.ord_check(cx, "path-show", "show path", |o| o.path.show, |o, v| o.path.show = v))
                            .child(
                                h_flex()
                                    .gap_2()
                                    .items_center()
                                    .child(ColorPicker::new(&l.path_color))
                                    .child(slider_row("thickness", &l.path_thickness, cx)),
                            )
                            .child(self.ord_check(cx, "path-dash", "dashed", |o| o.path.dashed, |o, v| o.path.dashed = v)),
                    ),
            )
            .child(separator())
            .child(div().mt_1().font_bold().child("Global"))
            .child(slider_row("active alpha", &l.active_alpha, cx))
            .child(slider_row("cancelled/closed visibility", &l.closed_alpha, cx))
            .child(self.ord_check(cx, "pending-dash", "pending order: dashed entry", |o| o.pending_dashed, |o, v| o.pending_dashed = v))
