...
use moon_ui::{
    ...
    MoonStatusItem, MoonTheme, MoonThemeConfig, MoonTooltipView, MoonWindowFrame, PanelView, Root,
    h_flex, init as init_moon_ui, v_flex,
};
...
impl Backend {
    ...
    fn take_diag_open_10_btc(&mut self) -> bool {
        ...
        if debug_chart_target(self).is_none() {
            return false;
        }
